      ...
      <ReactMarkdown
        ...
        components={{
          ...
          ol: ({node, ...props}) => {
            ...
            return <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6" {...props} />;
          },
          blockquote: ({node, ...props}) => (
            <div className="bg-white shadow-md rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-shadow" {...props} />
          ),
        }}
      >
        {content}
