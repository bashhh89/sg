              ...
              {item.links.map((link) => {
                ...
                return (
                  <div key={link.href} className="relative group">
                    ...
                    {isDisabled && 'tooltip' in link && link.tooltip && (
                      <div className="absolute left-full ml-2 top-0 z-10 w-48 p-2 bg-sg-dark-teal text-white text-xs rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                        {link.tooltip}
                      </div>
                    )}
                  </div>
