          ...
          <div className="bg-white/90 backdrop-blur-md border border-gray-100 rounded-3xl p-6 lg:p-10 shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center gap-6 mb-8">
                  <div className="md:w-1/3 flex-shrink-0">
                    <div className="aspect-square rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center p-1">
                      <div className="bg-white rounded-full w-full h-full flex items-center justify-center">
                        <div className="text-center">
                          <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-purple-600">
                            {DUMMY_REPORT.tier}
                          </div>
                  ...
                  <div className="md:w-2/3">
                    <h2 className="text-xl font-semibold text-gray-800 mb-3">Your AI Maturity: {DUMMY_REPORT.tier}</h2>
                    ...
                    <div className="flex items-center justify-between w-full bg-gray-100 rounded-full h-4 mb-4">
                      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 h-4 rounded-full w-2/3"></div>
                    </div>
                    <div className="flex justify-between text-sm text-gray-500">
                      <span>Dabbler</span>
                      <span className="font-medium text-indigo-600">Enabler</span>
                      <span>Leader</span>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'Key Findings' && (
              <div className="space-y-8">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                    <span className="w-8 h-8 bg-amber-100 text-amber-600 rounded-full flex items-center justify-center mr-2">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <ul className="space-y-3">
                    {DUMMY_REPORT.keyFindings.weaknesses.map((weakness, index) => (
                      <li key={index} className="bg-amber-50 p-4 rounded-lg">
                        <div className="flex">
                          <div className="flex-shrink-0 mr-3">
                          ...
                          <div>
                            <p className="font-medium text-gray-800">{weakness}</p>
                            <p className="text-sm text-gray-600 mt-1">
            ...
            {activeTab === 'Strategic Action Plan' && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-gray-800 mb-4">Your Personalized Action Plan</h2>
                ...
                <div className="space-y-6 mt-6">
                  {DUMMY_REPORT.actionPlan.map((action, index) => (
                    <div key={index} className="relative pl-8">
                      <div className="absolute left-0 top-0 w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 font-medium">
                        {index + 1}
                      </div>
                      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-100">
                          <div className="flex items-center text-sm">
                            ...
                            <span className="ml-2 px-2 py-1 bg-indigo-50 text-indigo-600 rounded text-xs font-medium">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                      ...
                      <h3 className="text-lg font-medium text-gray-800 mb-2">AI Strategy Playbook</h3>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                      ...
                      <h3 className="text-lg font-medium text-gray-800 mb-2">AI Implementation Workshop</h3>
                      <p className="text-gray-600 text-sm mb-4">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                      ...
                      <h3 className="text-lg font-medium text-gray-800 mb-2">AI ROI Calculator Template</h3>
                      <p className="text-gray-600 text-sm mb-4">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                      ...
                      <h3 className="text-lg font-medium text-gray-800 mb-2">AI Skills Assessment</h3>
                      <p className="text-gray-600 text-sm mb-4">
            ...
            {activeTab === 'Assessment Q&A' && (
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-4">Your Assessment Responses</h2>
                <p className="text-gray-600 mb-6">
                      ...
                      <div className="flex flex-col md:flex-row md:items-start gap-4">
                        <div className="md:w-8/12">
                          <div className="flex items-start mb-3">
                            <div className="flex-shrink-0 w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 font-medium mr-2 mt-0.5">
                              Q
                            </div>
                            <p className="font-medium text-gray-800">{qa.question}</p>
                          </div>
                          <div className="flex items-start pl-8">
                            <div className="flex-shrink-0 w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center text-purple-600 font-medium mr-2 mt-0.5">
                              A
                            </div>
