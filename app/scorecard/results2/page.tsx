...
export default function ScorecardResultsPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 text-gray-800 font-sans flex items-center justify-center">
        <div className="text-center animate-pulse">
          <div className="w-20 h-20 border-4 border-indigo-300 border-t-indigo-600 rounded-full animate-spin mx-auto mb-8"></div>
          <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 mb-2">Loading Your Scorecard</h2>
          <p className="text-gray-600 mt-2">Your insights are being prepared...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 text-gray-800 font-sans flex items-center justify-center">
        <div className="text-center max-w-lg mx-auto p-10 bg-white rounded-3xl shadow-2xl animate-fade-in">
          <div className="w-20 h-20 mx-auto mb-6 text-indigo-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>
          <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 mb-4">Scorecard Not Found</h2>
          <p className="text-gray-600 mb-8">We couldn't find your scorecard results. You may need to complete the assessment first.</p>
          
          <div className="flex flex-col gap-4 mt-4">
            <a 
              href="/" 
              className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
            >
              Start Assessment
            </a>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 text-gray-800 font-sans">
      {/* Background elements */}
      <div className="absolute inset-0 bg-pattern-grid opacity-5 z-0"></div>
      <div className="absolute top-0 right-0 w-1/3 h-screen bg-gradient-to-bl from-purple-100 via-transparent to-transparent z-0"></div>
      <div className="absolute bottom-0 left-0 w-1/2 h-1/3 bg-gradient-to-tr from-indigo-100 via-transparent to-transparent z-0"></div>
      
      {/* Decorative blobs */}
      <div className="absolute top-40 left-20 w-96 h-96 rounded-full bg-indigo-200 opacity-20 blur-4xl z-0"></div>
      <div className="absolute bottom-40 right-20 w-96 h-96 rounded-full bg-purple-200 opacity-20 blur-4xl z-0"></div>
      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="lg:w-72 bg-white/80 backdrop-blur-md shadow-lg p-6 flex flex-col">
          <div className="mb-8">
            <div className="text-2xl font-bold text-indigo-600 mb-1">AI Scorecard</div>
          ...
          <div className="mt-auto pt-6 border-t border-gray-100">
            <div className="flex items-center gap-3 text-gray-500 hover:text-indigo-600 transition-colors">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 bg-white/60 backdrop-blur-sm p-5 rounded-2xl shadow-sm">
            ...
            <div className="flex items-center space-x-3 mt-4 md:mt-0">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg shadow-md hover:shadow-lg transition-all"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`bg-white/90 backdrop-blur-md border border-gray-100 rounded-3xl p-6 lg:p-10 shadow-xl ${
              ...
              {!currentSectionMarkdown && activeTab !== 'Assessment Q&A Breakdown' && activeTab !== 'Learning Hub' && (
                <div className="text-center py-12">
                  <div className="w-16 h-16 mx-auto mb-6 text-indigo-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-semibold text-indigo-600 mb-4">Content Not Available</h3>
                  <p className="text-gray-600 max-w-md mx-auto">The content for the section "{cardTitles[activeTab]}" is currently not available or is being processed.</p>
                </div>
              )}
            </div>
          </div>
      ...
      <button 
        ...
        className="fixed bottom-6 right-6 bg-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-110 text-indigo-600 focus:outline-none"
