...
export default function ResultsDisplayPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="text-center">
          <div className="w-20 h-20 border-4 border-sg-mint-green border-t-sg-dark-teal rounded-full animate-spin mx-auto mb-8"></div>
          <h2 className="text-xl font-bold text-sg-dark-teal">Preparing Your Results</h2>
          <p className="text-gray-500 mt-2">Analyzing your assessment data...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="bg-white rounded-2xl shadow-xl p-12 max-w-md text-center">
          ...
          <p className="mb-8 text-gray-600">You need to complete the assessment first to view your personalized AI Efficiency Scorecard.</p>
          <a 
            href="/" 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 pb-20">
      {/* Header */}
      <div className="bg-gradient-to-r from-sg-dark-teal to-[#005a66] text-white py-8 px-6 md:px-12 mb-8 relative overflow-hidden">
            ...
            <div className="md:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-2xl font-bold text-center text-gray-800 mb-2">{getUserTier()}</h3>
            ...
            <div className="md:col-span-2">
              <div className="bg-white rounded-2xl shadow-lg h-full">
                <div className="px-6 py-6 border-b border-gray-100">
                  <h2 className="text-2xl font-bold text-gray-800">Strategic Action Plan</h2>
                  <p className="text-gray-600">Top recommendations based on your assessment</p>
                </div>
                <div className="p-6">
                  <div className="space-y-4">
                    {sections['Strategic Action Plan']?.split(/\d+\.\s+\*\*[^*]+\*\*/)
                      ...
                      .map((item, index) => (
                        <div 
                          key={index}
                          className="flex items-start p-4 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer"
                        >
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="px-6 py-6 border-b border-gray-100">
                ...
                <p className="text-gray-600">Insights from your AI efficiency assessment</p>
              </div>
              <div className="p-6">
        ...
        {activeTab === 'action-plan' && (
          <div>
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="px-6 py-6 border-b border-gray-100">
                <h2 className="text-2xl font-bold text-gray-800">Strategic Action Plan</h2>
                <p className="text-gray-600">Recommended steps to improve your AI efficiency</p>
              </div>
              <div className="p-6">
                <div className="whitespace-pre-line">
        ...
        {activeTab === 'full-report' && (
          <div>
            <div className="mb-6 flex justify-between items-center">
              <h2 className="text-2xl font-bold text-gray-800">Full Assessment Report</h2>
              <button 
                onClick={() => setShowQA(!showQA)}
                className="bg-white px-4 py-2 rounded-lg shadow hover:shadow-md transition-shadow text-gray-700"
              >
            ...
            {showQA && (
              <div className="mt-6">
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Assessment Q&A History</h3>
                  <div className="space-y-4">
                    {questionAnswerHistory.map((item, index) => (
                      <div key={index} className="border-b border-gray-100 pb-4 last:border-0">
                        <p className="font-bold text-gray-800 mb-2">Q: {item.question}</p>
                        <p className="text-gray-600">A: {typeof item.answer === 'string' ? item.answer : JSON.stringify(item.answer)}</p>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex space-x-4">
            <a 
              ...
              className="text-gray-600 hover:text-sg-dark-teal transition-colors"
            >
              View New Design
            </a>
